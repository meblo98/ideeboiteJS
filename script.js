...
formIdee.addEventListener("submit", (e) => {
    ...
    if (category === "Sélectionnez une catégorie") {
        showError(document.getElementById('category'), "Veuillez sélectionner une catégorie");
        isValid = false;
    } else {
    ...
    if (!description) {
        showError(document.getElementById('description'), "Veuillez saisir une description");
        isValid = false;
    } else {
